...
class Test(unittest.TestCase):
    def test_getProposal(self):
        ...
        proposal, instrument = UtilsISPyB.getProposalInstrument(movie_file_path)
        self.assertEqual("mx2001", proposal)
        self.assertEqual("cm01", instrument)
        ...
        self.assertEqual("cm01", instrument)
        movie_file_path = "/data/visitor/mx2112/cm02/20220426/PROCESSED_DATA/igm-grid3-2"
        proposal, instrument = UtilsISPyB.getProposalInstrument(movie_file_path)
        self.assertEqual("mx2112", proposal)
        self.assertEqual("cm02", instrument)

    def test_getProposalInhouse(self):
        movie_file_path = "/data/visitor/ihls3404/cm01/20220707/RAW_DATA/IHLS_3404_FluPol/. "
        proposal = UtilsISPyB.getProposalInstrument(movie_file_path)
